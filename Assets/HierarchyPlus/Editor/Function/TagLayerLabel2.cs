...
{
    public class TagLayerLabel2 : FunctionButton
    {
        ...
        public override float Layout(GameObject go, float offset, float expand = 0)
        {
            ...
            _LayerLabel = _Layer.ConvertTagLayerLabel((TagLayerLabelOption)Prefs.fbTagLayer2LabelOption, Prefs.fbTagLayer2Chop, Prefs.fbTagLayer2ChopTo);
            _TagLabel = go.tag.ConvertTagLayerLabel((TagLayerLabelOption)Prefs.fbTagLayer2LabelOption, Prefs.fbTagLayer2Chop, Prefs.fbTagLayer2ChopTo);

            if (!Prefs.fbTagLayer2SmallFont)
            {
            ...
            var op = (TagLayerOption)Prefs.fbTagLayer2Option;
            if (NeedInvert())
            {
            ...
            _ShowTag = !Prefs.fbTagLayer2HideDefault || go.tag != "Untagged";
            _ShowLayer = !Prefs.fbTagLayer2HideDefault || go.layer != 0;
            switch (op)
            {
        ...
        public override float Draw(GameObject go, Rect itemRect)
        {
            ...
            if (_ShowLayer)
            {
                ...
                layercolor = Prefs.fbTagLayer2NoColorTint ? labelColor : layercolor;
        ...
        {
            if (Prefs.fbTagLayer2Option == (int)TagLayerOption.Both) return false;
            return Utility.CheckModifierKey((ModifierKey)Prefs.fbTagLayer2Invert);
        }
